...
export default function ServiceFAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'ขั้นต่ำ 3 เดือน สำหรับ Serviced Office ส่วน Co-Working Space และ Meeting Room สามารถใช้งานรายชั่วโมงได้ตามความต้องการ',
    },
    {
    ...
    },
    {
      ...
      answer:
        'ชำระแค่ค่าเช่าและค่าไฟ ส่วนบริการอื่นๆ ได้แก่ Wi-Fi ความเร็วสูง, น้ำ, แอร์, ทำความสะอาด, รักษาความปลอดภัย 24 ชั่วโมง และรับส่งจดหมาย ฟรีทั้งหมด',
    },
    {
    ...
    },
    {
      ...
      answer:
        'มีที่จอดรถให้ลูกค้าฟรี สำหรับลูกค้าและสมาชิกทุกประเภท ไม่คิดค่าบริการ',
    },
    {
      question: 'สามารถเข้าชมสำนักงานก่อนตัดสินใจเช่าได้หรือไม่?',
      answer:
        'ได้แน่นอนครับ เรายินดีให้คุณเข้าชมสำนักงานและพื้นที่ต่างๆ ก่อนตัดสินใจ โดยสามารถนัดหมายล่วงหน้าได้ที่ 063-441-4239 หรือแอดไลน์ @starwork',
    },
  ];
