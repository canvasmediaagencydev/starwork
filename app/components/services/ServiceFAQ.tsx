  ...
  const faqs = [
    {
      ...
      answer:
        'คุณสามารถจองบริการได้ 3 วิธี: 1) โทรติดต่อที่ +66 XX XXX XXXX 2) ส่งอีเมลมาที่ info@starwork.co.th 3) กรอกแบบฟอร์มจองเข้าชมในเว็บไซต์ของเรา ทีมงานจะติดต่อกลับภายใน 24 ชั่วโมง',
    },
    {
    ...
    },
    {
      ...
      answer:
        'ได้แน่นอนครับ เรายินดีให้คุณเข้าชมสำนักงานและพื้นที่ต่างๆ ก่อนตัดสินใจ โดยสามารถนัดหมายล่วงหน้าได้ที่ +66 XX XXX XXXX หรือจองผ่านเว็บไซต์',
    },
    {
